...
export default function CartSidebar() {
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 w-full sm:w-96 bg-white dark:bg-gray-900 shadow-2xl transform transition-transform duration-300 ease-in-out z-50 overflow-hidden ${
        isOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
      <div className="h-full flex flex-col">
        {/* Cart Header */}
        <div className="p-6 border-b bg-pink-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        {items.length > 0 && (
          <div className="p-6 border-t bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
            ...
            <Button
              ...
              className="w-full bg-pink-500 hover:bg-pink-600 text-white py-3 px-4 h-auto font-medium transition-colors flex items-center justify-center space-x-2"
            >
